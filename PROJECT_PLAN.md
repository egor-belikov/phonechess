...
- Партии турнира **учитываются в рейтинге** blitz/rapid так же, как обычные матчи того же контроля.
...
- Рейтинги blitz/rapid ведутся с базой старта `1500` и автопересчетом по результатам, **включая партии турниров**.
