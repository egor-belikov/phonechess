...
- Добавлены премувы, индикация очереди премувов, и build-info на экране.
- Налажен цикл быстрого деплоя на VPS с Docker Compose.

### Ближайшие приоритеты

1. Устойчивость и UX премувов (стрелки/кнопка очистки, полировка touch-жестов).
2. Приватные игры и приглашения в Telegram.
3. Профиль/рейтинг/история партий.
4. Наблюдение за партиями (топ-партии, режим зрителя).
5. Стабильный CI/CD без ручного копирования файлов.
